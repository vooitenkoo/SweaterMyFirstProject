package com.example.sweater_2.controller;

import com.example.sweater_2.domain.Role;
import com.example.sweater_2.domain.User;
import com.example.sweater_2.service.UserService;
...
public class UserController {
    ...
    public String deleteUser(@RequestParam String username, Model model) {
       userSevice.userDelete(username,model);
        return "redirect:/user"; // Показываем страницу "user" с успехом
    }
}